    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50">
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              ...
              disabled={saving}
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors disabled:opacity-50 text-sm sm:text-base"
            >
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        ...
        <div className="relative mb-8 sm:mb-8">
          <div className="h-32 sm:h-48 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg sm:rounded-xl overflow-hidden">
            {settings.coverPicture ? (
              <img src={settings.coverPicture} alt="Cover" className="w-full h-full object-cover" />
            ) : (
              <div className="w-full h-full flex items-center justify-center">
                <ImageIcon className="w-10 h-10 sm:w-16 sm:h-16 text-white opacity-50" />
              </div>
            )}
          </div>
          <label className="absolute bottom-2 sm:bottom-4 right-2 sm:right-4 cursor-pointer">
            <input
              type="file"
              accept="image/*"
              className="hidden"
            ...
            />
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              <Camera className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600" />
              <span className="text-xs sm:text-sm font-medium text-gray-700">
                {uploadingCover ? 'Uploading...' : <><span className="hidden sm:inline">Change </span>Cover</>}
              </span>
            </div>
          </label>
          ...
          <div className="absolute -bottom-12 sm:-bottom-16 left-4 sm:left-8">
            <div className="relative">
              <div className="w-20 h-20 sm:w-32 sm:h-32 rounded-full border-2 sm:border-4 border-white overflow-hidden bg-white shadow-xl">
                {settings.profilePicture ? (
                  <img src={settings.profilePicture} alt="Profile" className="w-full h-full object-cover" />
                ) : (
                  <div className="w-full h-full flex items-center justify-center bg-orange-100">
                    <User className="w-10 h-10 sm:w-16 sm:h-16 text-orange-600" />
                  </div>
                )}
              </div>
              <label className="absolute bottom-0 right-0 cursor-pointer">
                ...
                />
                <div className="p-1.5 sm:p-2 bg-orange-600 rounded-full shadow-lg hover:bg-orange-700 transition-colors">
                  {uploadingProfile ? (
        ...
        <div className="mt-14 sm:mt-20">
          {/* Section Tabs - Mobile Scrollable */}
          <div className="flex gap-2 mb-6 sm:mb-8 overflow-x-auto pb-2 scrollbar-hide">
            {[
              ...
              { id: 'fitness', label: 'Fitness Profile', shortLabel: 'Fitness', icon: Dumbbell },
              { id: 'nutrition', label: 'Nutrition', shortLabel: 'Nutrition', icon: Utensils },
              { id: 'health', label: 'Health & Lifestyle', shortLabel: 'Health', icon: Heart },
              { id: 'goals', label: 'Goals & Targets', shortLabel: 'Goals', icon: Target }
            ].map(({ id, label, shortLabel, icon: Icon }) => (
              <button
                key={id}
                onClick={() => setActiveSection(id as any)}
                className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-lg whitespace-nowrap transition-colors text-sm sm:text-base ${
                  activeSection === id
          ...
          {activeSection === 'personal' && (
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg space-y-4 sm:space-y-6">
          ...
          {activeSection === 'fitness' && (
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg space-y-4 sm:space-y-6">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Fitness Profile</h2>
          ...
          {activeSection === 'nutrition' && (
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg space-y-4 sm:space-y-6">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Nutrition & Diet</h2>
          ...
          {activeSection === 'health' && (
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg space-y-4 sm:space-y-6">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Health & Lifestyle</h2>
          ...
          {activeSection === 'goals' && (
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg space-y-4 sm:space-y-6">
              <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Goals & Targets</h2>
