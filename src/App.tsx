        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            ...
            >
              ...
              <span>Sign In with Google & Save Your Spot</span>
            </button>
          </div>

          <p className="text-sm text-gray-500 mb-12">Secure your place and get early access to AI features</p>
      ...
      <section id="features" className="relative z-10 py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-3xl hover:shadow-2xl transition transform hover:-translate-y-2">
              <div className="bg-orange-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
                <Target className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-4">AI Fitness Planning</h3>
              <p className="text-gray-700 leading-relaxed">
                Tell us your goal and our AI generates complete workout plans, meal plans, and daily schedules. From weight loss to muscle building, everything is personalized for your success.
              </p>
            </div>

            <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-3xl hover:shadow-2xl transition transform hover:-translate-y-2">
              ...
              <p className="text-gray-700 leading-relaxed">
                Get matched daily with an accountability partner who complements your journey. Share progress, motivate each other, and crush goals together. Having someone who gets it makes all the difference.
              </p>
            </div>

            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-8 rounded-3xl hover:shadow-2xl transition transform hover:-translate-y-2">
              ...
              <p className="text-gray-700 leading-relaxed">
                Log daily weight, calories, macros, workouts, and progress photos. Beautiful charts show your transformation. Stay consistent with streaks and achievements. Watch yourself transform.
              </p>
            </div>
          </div>
        </div>
